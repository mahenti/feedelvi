    ...
    <footer className="bg-[#133425] text-white overflow-hidden" style={{ fontFamily: 'Onest, sans-serif' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="mb-20">
          ...
          <p className="text-2xl md:text-3xl text-[#e7dbbf] font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a href="mailto:info@feedelvi.fi" className="flex items-center gap-3 group">
                <Mail className="w-5 h-5 text-[#2d805b]" />
                <span className="text-lg group-hover:text-[#e7dbbf] transition-colors">
                  info@feedelvi.fi
                </span>
              </a>
              <a href="tel:+358123456789" className="flex items-center gap-3 group">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {['Bovine Nutrition', 'Ovine-Caprine', 'Porcine Feed', 'Lagomorph', 'Poultry Range'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-lg text-white/80 hover:text-[#e7dbbf] transition-colors flex items-center gap-2 group">
                    {item}
